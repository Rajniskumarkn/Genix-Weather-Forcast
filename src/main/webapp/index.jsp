...
<div class="mainContainer">
    <form action="MyServlet" method="post" class="searchInput">
        <input type="text" class="form-control" id="searchInput" name="city" placeholder="Enter City Name" required>
...
<script>
    // Update weather icon dynamically based on weather condition value
    ...
    case 'Haze':
	  ...
	  <!-- Footer -->
<footer style="position: fixed; bottom: 0; left: 0; width: 100%; background: rgba(0,0,0,0.6); text-align: center; padding: 10px 0; color: white; font-size: 14px;">
    &copy; 2025 Weather Genix | Designed by Rajnish Kumar
</footer>
